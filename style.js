	...
	diaporamademoStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Icono ecrite compréhension', element: 'span', attributes: { 'class': 'icon ecrite-compréhension' } },
				{ name: 'Icono oral compréhension', element: 'span', attributes: { 'class': 'icon oral-compréhension' } },
				{ name: 'Icono lapiz compréhension', element: 'span', attributes: { 'class': 'icon lapiz-compréhension' } },
				{ name: 'Icono hablar compréhension', element: 'span', attributes: { 'class': 'icon hablar-compréhension' } },
